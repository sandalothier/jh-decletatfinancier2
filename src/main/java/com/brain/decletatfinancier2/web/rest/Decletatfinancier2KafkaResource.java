...
@RestController
@RequestMapping("/api/decletatfinancier-2-kafka")
public class Decletatfinancier2KafkaResource {

    private final Logger log = LoggerFactory.getLogger(Decletatfinancier2KafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Decletatfinancier2KafkaResource(KafkaProperties kafkaProperties) {
