package com.brain.decletatfinancier2.web.rest;

import com.brain.decletatfinancier2.config.KafkaProperties;
...
class Decletatfinancier2KafkaResourceIT {
    ...
    void setup() {
        ...
        Decletatfinancier2KafkaResource kafkaResource = new Decletatfinancier2KafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc.perform(post("/api/decletatfinancier-2-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc.perform(get("/api/decletatfinancier-2-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
